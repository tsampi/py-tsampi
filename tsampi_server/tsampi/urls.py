...
from tsampi.views import AppList, AppDetail, ResultDetail, TaskDetail, index_view, PullView
...
urlpatterns = [
    ...
    url(r'^result/(?P<task_id>[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12})/$',
        ResultDetail.as_view(), name='result-detail'),
